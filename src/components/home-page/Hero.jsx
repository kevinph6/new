...
function Hero() {
  ...
  return (
    <>
      <div className="min-h-[calc(100vh-110px)] flex flex-col  justify-center w-full bg-[#abd3df]">
            ...
            <div className="md:max-w-[630px]">
              <div className="">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-white text-base sm:text-lg text-shadows2 tracking-[0.37px]">
                    Audit KYC Verified
                  </p>
                </div>
                <h1 className="text-[50px] md:text-[60px] lg:text-[70px] xl:text-[95px] font-normal  leading-[100%] tracking-[1px] uppercase  text-white main-heading text-clean font-milky  mt-4 ">
                  {" "}
                  Welcome to the Lisana
                </h1>
                <p className="text-white text-lg sm:text-xl md:text-2xl  xl:text-[30px]  text-shadows2 tracking-[0.58px] leading-[140%]  mt-6 lg:mt-8  ">
                  Over 10m raised. Last chance to buy before launch!
                </p>
